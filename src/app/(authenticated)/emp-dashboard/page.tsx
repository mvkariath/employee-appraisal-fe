...
import { Users, CheckCircle2, Clock, Star, MessageCircle } from "lucide-react";

// Hardcoded employee summary and feedback data
...
const feedbackList = [
	{
		comment: "Great teamwork and communication this quarter.",
		givenBy: "Mike Chen",
		date: "2024-03-20",
	},
	{
		comment: "Consistently meets deadlines and delivers quality work.",
		givenBy: "Lisa Park",
		date: "2024-02-10",
	},
	{
		comment: "Needs to improve participation in meetings.",
		givenBy: "John Smith",
		date: "2024-01-25",
	},
];
			...
			<div className="container mx-auto px-6 py-8">
				<div className="mb-8">
					...
					<p className="text-lg text-gray-600">
						Here is your latest appraisal summary and feedback.
					</p>
				</div>
						...
						<CardContent className="p-6">
							<div className="flex items-center justify-between">
								<div>
									...
									<p className="text-3xl font-bold">
										{employeeSummary.lastAppraisalDate}
									</p>
								</div>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Overview of your latest performance review.
							</CardDescription>
						</CardHeader>
						<CardContent>
							<div className="space-y-2">
								...
								<div>
									<span className="font-semibold">Last Appraisal:</span>{" "}
									{employeeSummary.lastAppraisalDate}
								</div>
								<div>
									<span className="font-semibold">Status:</span>{" "}
									<Badge>{employeeSummary.status}</Badge>
								</div>
								<div>
